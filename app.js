...
let data=LabData.empty(),user={role:'student'},version=0,students=[],labLeadAuthor='',labMemberAuthors=[],tab='home',meetingGroup='all',showPastMeetings=false,fundTab='internal',term='2026-2 인건비(안)',busy=false,exportRows=[];
